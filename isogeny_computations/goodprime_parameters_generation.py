...
if __name__=="__main__":
	...
	with open('GoodPrime_SharingPath_Parameters.txt','w',encoding='utf-8') as f:
		f.write(str(d_params_save))
	d_params_ret=read_params_SIKE('GoodPrime_SharingPath_Parameters.txt')
